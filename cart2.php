...
<td class="quantity">
<input type="number" name="quantity" id="<?php echo $values["code"]; ?>" value="<?php echo $values["food_quantity"] ?>" min="1" max="25" placeholder="Quantity" required></td>
...
<td><a href="cart.php?action=edit&id=<?php echo $values["food_id"]; ?>"><span class="text-danger">Update</span></a></td>
</tr>
<?php 
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Empty Cart</button></a>&nbsp;<a href="foodmenu2.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp; <a href="updatequantity.php"><button class="btn btn-warning">Update</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button> </a>';
?>
</div>
...
if(empty($_SESSION["cart"]) && isset($_POST["add"]))
{
  ?>
   <div class="alert alert-success">
              <strong>Success!</strong><p><a href="cart2.php"> Click Me </a></p> 
            </div>
