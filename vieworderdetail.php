...
<div class="container">
    <div class="container">
      ...
      <div class="list-group">
        ...
        <a href="vieworderdetail.php" class="list-group-item active">View Order Details</a>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td><div class="form-group" >
           <a href="updatestatus.php?id=<?php echo $row["order_id"]; ?> ">Change Status</a>
            </div></td>
